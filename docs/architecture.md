...
Simulation advances in discrete ticks (internal unit). The UI displays "days" (1 day = 120 ticks, so 5 ticks = 1 hour). "Real-time" = ticks fire automatically. "Pause" = they don't. Saves are always at a tick boundary. The engine has no concept of wall-clock time.
