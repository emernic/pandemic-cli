...
The same instinct takes other forms too — breaking plain sentences into short fragments to create punch. "Corporate revenues are down. Containment policies are named." is the same failure as "THE ARK PROTOCOL": the text is doing work that the situation should do. "Corporate revenues are down and your containment policies are getting the blame." just says what happened. If you find yourself adjusting sentence rhythm to create atmosphere, stop. The content creates the atmosphere. The prose just reports.
