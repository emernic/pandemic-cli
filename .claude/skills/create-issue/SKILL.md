...
4. **Do NOT prematurely plan the solution.** The issue describes a *problem* or *need*, not an implementation plan. Resist the urge to design the fix. The person working on this issue will figure out the right approach themselves.
